...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.ID = field.NewInt(tableName, "id")
	_customer.Code = field.NewString(tableName, "code")
	_customer.Name = field.NewString(tableName, "name")
	_customer.Account = field.NewString(tableName, "account")
	_customer.Password = field.NewString(tableName, "password")
	_customer.Mobile = field.NewString(tableName, "mobile")
	_customer.LastLoginAt = field.NewTime(tableName, "last_login_at")
...
func (c *customer) updateTableName(table string) *customer {
	...
	c.LastLoginAt = field.NewTime(table, "last_login_at")
